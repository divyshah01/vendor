    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('PROCUREMENT_OFFICER', 'Procurement Officer'), ('MANAGER', 'Manager / Approver'), ('VENDOR', 'Vendor')], default='PROCUREMENT_OFFICER', max_length=25)),
